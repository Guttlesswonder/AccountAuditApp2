...
export function createEmptyAccount(name = 'New Account'): AccountRecord {
  ...
  return {
    ...
    thirdPartyVendorsSummary: '',
    technologyGapSummary: '',
    vendorPainPointSummary: '',
    solveByProductOrRoadmap: '',
    hasDataWarehouse: false,
    dataWarehouseTools: '',
    sentimentAssessment: { questionType: 'sentiment', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', entries: [] },
    retentionAssessment: { questionType: 'retention', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', owner: '', relatedNextStep: '', tags: '', entries: [] },
    opportunityAssessment: { questionType: 'whitespace', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', owner: '', relatedNextStep: '', tags: '', entries: [] },
    nextActionAssessment: { questionType: 'next_actions', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', owner: '', relatedNextStep: '', tags: '', entries: [{ id: crypto.randomUUID(), action: '', owner: '', targetDate: '', audience: 'internal', priority: '', notes: '' }, { id: crypto.randomUUID(), action: '', owner: '', targetDate: '', audience: 'internal', priority: '', notes: '' }, { id: crypto.randomUUID(), action: '', owner: '', targetDate: '', audience: 'internal', priority: '', notes: '' }] },
    hasDenticon: true,
    hasCloud9: false,
    hasApteryx: false,
    termsSummary: '',
