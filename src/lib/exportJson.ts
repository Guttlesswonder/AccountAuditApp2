...
export function parseImportedAccount(raw: string): AccountRecord {
  ...
  return {
    ...
    thirdPartyVendorsSummary: parsed.thirdPartyVendorsSummary ?? '',
    technologyGapSummary: parsed.technologyGapSummary ?? '',
    vendorPainPointSummary: parsed.vendorPainPointSummary ?? '',
    solveByProductOrRoadmap: parsed.solveByProductOrRoadmap ?? '',
    hasDataWarehouse: !!parsed.hasDataWarehouse,
    dataWarehouseTools: parsed.dataWarehouseTools ?? '',
    sentimentAssessment: parsed.sentimentAssessment ?? { questionType: 'sentiment', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', entries: [] },
    retentionAssessment: parsed.retentionAssessment ?? { questionType: 'retention', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', owner: '', relatedNextStep: '', tags: '', entries: [] },
    opportunityAssessment: parsed.opportunityAssessment ?? { questionType: 'whitespace', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', owner: '', relatedNextStep: '', tags: '', entries: [] },
    nextActionAssessment: parsed.nextActionAssessment ?? { questionType: 'next_actions', overallScore: '', confidence: '', rationale: '', evidence: '', evidenceDate: '', owner: '', relatedNextStep: '', tags: '', entries: [{ id: crypto.randomUUID(), action: '', owner: '', targetDate: '', audience: 'internal', priority: '', notes: '' }, { id: crypto.randomUUID(), action: '', owner: '', targetDate: '', audience: 'internal', priority: '', notes: '' }, { id: crypto.randomUUID(), action: '', owner: '', targetDate: '', audience: 'internal', priority: '', notes: '' }] },
